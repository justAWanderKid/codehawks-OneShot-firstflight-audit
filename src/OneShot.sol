...
contract OneShot is IOneShot, ERC721URIStorage, Ownable {
    ...
    // [INFO] @audit `mintRapper` And `updateRapperStats` function can be marked as external.
    function updateRapperStats(uint256 tokenId, bool weakKnees, bool heavyArms, bool spaghettiSweater, bool calmAndReady, uint256 battlesWon) public onlyStreetContract {
